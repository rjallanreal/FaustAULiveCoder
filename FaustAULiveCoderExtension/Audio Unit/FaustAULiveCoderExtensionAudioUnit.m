//
//  FaustAULiveCoderExtensionAudioUnit.m
//  FaustAULiveCoderExtension
//
//  Created by Ryan Allan on 8/19/21.
//

#import "FaustAULiveCoderExtensionAudioUnit.h"
...
@interface FaustAULiveCoderExtensionAudioUnit ()
...
@implementation FaustAULiveCoderExtensionAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[FaustAULiveCoderExtensionDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block FaustAULiveCoderExtensionDSPKernelAdapter * kernelAdapter = _kernelAdapter;

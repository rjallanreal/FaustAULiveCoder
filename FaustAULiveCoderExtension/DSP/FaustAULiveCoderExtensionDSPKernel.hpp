//
//  FaustAULiveCoderExtensionDSPKernel.hpp
//  FaustAULiveCoderExtension
//
//  Created by Ryan Allan on 8/19/21.
//

#ifndef FaustAULiveCoderExtensionDSPKernel_hpp
#define FaustAULiveCoderExtensionDSPKernel_hpp
...
/*
 FaustAULiveCoderExtensionDSPKernel
 Performs simple copying of the input signal to the output.
 As a non-ObjC class, this is safe to use from render thread.
 */
class FaustAULiveCoderExtensionDSPKernel : public DSPKernel {
public:
...
#endif /* FaustAULiveCoderExtensionDSPKernel_hpp */
